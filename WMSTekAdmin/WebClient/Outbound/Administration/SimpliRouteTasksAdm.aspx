<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="SimpliRouteTasksAdm.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Administration.SimpliRouteTasksAdm" %>
                                        ...
                                        <asp:GridView ID="grdMgr" runat="server" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:templatefield HeaderText="Estado" AccessibleHeaderText="NameTrackTaskQueue" >
                                                    <itemtemplate>
                                                        <asp:label ID="lblNameTrackTaskQueue" runat="server" text='<%#   ((string)Eval("TrackTaskQueue.NameTrackTaskQueue") == "Primer Paso Exitoso") ? "Enviado" : Eval("TrackTaskQueue.NameTrackTaskQueue")   %>' Visible='<%# (string)Eval("TrackTaskQueue.NameTrackTaskQueue") == "Primer Paso Exitoso" %>' />
                                                        <asp:label ID="Label1" runat="server" text='<%#   ((string)Eval("TrackTaskQueue.NameTrackTaskQueue") == "Segundo Paso Exitoso") ? "Recibido" : Eval("TrackTaskQueue.NameTrackTaskQueue")   %>' Visible='<%# (string)Eval("TrackTaskQueue.NameTrackTaskQueue") == "Segundo Paso Exitoso" %>' />
                                                        <asp:label ID="Label2" runat="server" text='<%#  Eval ( "TrackTaskQueue.NameTrackTaskQueue" )   %>' Visible='<%# ((string)Eval("TrackTaskQueue.NameTrackTaskQueue") != "Primer Paso Exitoso") && ((string)Eval("TrackTaskQueue.NameTrackTaskQueue") != "Segundo Paso Exitoso" ) %>' /> 
                    ...
                    <div class="modalControls">
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divIdTruckCode" runat="server" class="divControls">
                                ...
                                <div class="fieldLeft">
                                    <asp:TextBox SkinID="txtFilter" ID="txtIdTruckCode" runat="server" Width="150px" Enabled="false" />
                                </div>
