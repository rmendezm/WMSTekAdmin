<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="ReleaseOrderWavePTLMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Administration.ReleaseOrderWavePTLMgr" %>
...
<script type="text/javascript" language="javascript">
                                ...
                                <div id="divSelected" runat="server">                                                
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="CompliancePct"  HeaderText="% Satisf.">
                                         ...
                                         <asp:TemplateField AccessibleHeaderText="SpecialField1"  HeaderText="Total Lineas">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                            ...
                                            <asp:TemplateField AccessibleHeaderText="SpecialField2"  HeaderText="Total Items">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                        ...
                                        <asp:TemplateField AccessibleHeaderText="SpecialField3"  HeaderText="Max. Por Linea">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                     ...
                     <asp:UpdatePanel ID="upSimulacion" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                           ...
                           <div id="divSimulation" runat="server">
                                 <div class="divGridTitleDispatch">
                                    <div class="divCenter"><asp:Label ID="lblSimulationTitle" runat="server" Text="Simulación" /></div>
                              ...
                              <%-- Detalle Simulación --%>     
                              <div id="divDetailSim" runat="server" class="divGridDetailScroll" visible="false">
                                      ...
                                      <asp:GridView ID="grdDetailSim" runat="server" SkinID="grdDetail"
                                            ...
                                            EnableViewState="False" 
                                            AllowPaging="False"
                                            OnDataBound="grdDetailSim_OnDataBound"
                                            ...
                                            EnableTheming="false">
                                             ...
                                             <Columns>
                                                   <asp:TemplateField HeaderText="Item" AccessibleHeaderText="ItemCode">
                                                    ...
                                                    <asp:TemplateField HeaderText="Solicitado" AccessibleHeaderText="ProposalTotalQty">
                                                        <ItemTemplate>
                                                            <div style="word-wrap: break-word;">
                                                                <asp:Label ID="lblProposalTotalQty" runat="server" text='<%# GetFormatedNumber(Eval ( "ProposalQty" )) %>'/>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Stock" AccessibleHeaderText="TotalQty">
                                                        <ItemTemplate>
                                                            <div style="word-wrap: break-word;">
                                                                <asp:Label ID="lblTotalQty" runat="server" text='<%# GetFormatedNumber(Eval ( "RealQty" )) %>'/>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Precio" AccessibleHeaderText="Price">
                                                        <ItemTemplate>
                                                            <div style="word-wrap: break-word;">
                                                                <asp:Label ID="lblPrice" runat="server" text='<%# Eval ( "OutboundDetail.Item.Price" ) %>'/>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Nro. Doc." AccessibleHeaderText="DocumentNumber">
                                                        <ItemTemplate>
                                                            <div style="word-wrap: break-word;">
                                                                <asp:Label ID="lblDocumentNumber" runat="server" text='<%# Eval ( "OutboundDetail.OutboundOrder.Number" ) %>'/>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Cliente" AccessibleHeaderText="CustomerName">
                                                        <ItemTemplate>
                                                            <div style="word-wrap: break-word;">
                                                                <asp:Label ID="lblCustomerName" runat="server" text='<%# Eval ( "OutboundDetail.OutboundOrder.CustomerName" ) %>'/>
                                                            </div>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>                                                
             ...
             <div id="divPendingOrders" runat="server" visible="false">
                 ...
                 <asp:Panel ID="pnlPendingOrders" runat="server" CssClass="modalBox">
                     ...
                     <div id="divCtrs1" style="height: 520px; width: 920px; " class="modalControls">
                         <div class="modalBoxContent" style="max-height:510px;">  
                             ...
                             <asp:GridView ID="grdMgr" runat="server" 
                                    ...
                                    <asp:BoundField DataField="SpecialField1" HeaderText="Total Lineas" AccessibleHeaderText="SpecialField1"
                                        SortExpression="SpecialField1" ItemStyle-Wrap="false"  ItemStyle-CssClass="text">
                                        <ItemStyle Wrap="False"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SpecialField2" HeaderText="Total Items" AccessibleHeaderText="SpecialField2"
                                        SortExpression="SpecialField2" ItemStyle-Wrap="false"  ItemStyle-CssClass="text">
                                        <ItemStyle Wrap="False"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="SpecialField3" HeaderText="Max. Por Linea" AccessibleHeaderText="SpecialField3"
		                ...
		                <div class="modalControls">
		                    <div id="divModalFields" runat="server" class="divCtrsFloatLeft">
                                ...
                                <div id="divLocStageDispatch" runat="server" class="divControls">      
		                            ...
		                            <div class="fieldLeft">
		                                <asp:DropDownList ID="ddlLocStageDispatch" runat="server" Width="140" />
                                ...
                                <div id="divLocDock" runat="server" class="divControls">      
		                            ...
		                            <div class="fieldLeft">
		                                <asp:DropDownList ID="ddlLocDock" runat="server" Width="140" />
    ...
    <asp:Label id="lblQuestionPendinOrders" runat="server" Text="¿Se eliminaran los pedidos seleccionados, desea continuar?" Visible="false" /> 
    <asp:Label ID="lblNotExistItemUom" runat="server" Text="Para el ítem [ITEM] no se encontro presentacion de Unidad." Visible="false"/>
    <asp:Label ID="lblTitleSimulate" runat="server" Text="Simular Pedidos" Visible="false"/>
    <asp:Label id="lblNroOrderQueuedSimulated" runat="server" Text="OLA simulada de forma Batch" Visible="false" /> 
    <asp:Label id="lblNroWaveQueuedGenerate" runat="server" Text="Numero de OLA PTL Generada de forma Batch: [NROWAVE]" Visible="false" /> 
