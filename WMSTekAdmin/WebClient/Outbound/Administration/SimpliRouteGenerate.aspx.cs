...
{
    public partial class SimpliRouteGenerate : BasePage
    {
        ...
        {
            context.SessionInfo.IdPage = "SimpliRouteGenerate";
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.Master.ucMainFilter.listTrackOutboundType = GetConst("SimpliRouteGenerateTrackOutboundType");
