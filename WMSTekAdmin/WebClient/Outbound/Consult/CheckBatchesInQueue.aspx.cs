...
{
    public partial class CheckBatchesInQueue : BasePage
    {
        ...
        private String docSimUrl
        {
            get
            {
                if (Request.QueryString["DOC"] != null && Request.QueryString["DOC"] != String.Empty)
            ...
            try
            {
                ...
                if (base.webMode == WebMode.Normal)
                {
                    ...
                    if (!IsPostBack)
                    {
                        ...
                        {
                            TextBox txtNumber = (TextBox)this.Master.ucMainFilter.FindControl("txtFilterDocumentNumber");
        ...
        protected void grdMgr_RowEditing(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                taskQueueViewDTO = (GenericViewDTO<TaskQueue>)Session[WMSTekSessions.CheckBatchesInQueue.List];
        ...
        {
            context.SessionInfo.IdPage = "CheckBatchesInQueue";
        ...
        private void UpdateSession()
        {
            ...
            CreateFilterByList("IdTypeTask", new List<int>() { (int)eTypeTaskQueue.ReleaseBatch });

            taskQueueViewDTO = iDispatchingMGR.GetBatchesInQueue(context);

            if (!taskQueueViewDTO.hasError() && taskQueueViewDTO.Entities != null)
            {
                Session.Add(WMSTekSessions.CheckBatchesInQueue.List, taskQueueViewDTO);
                isValidViewDTO = true;
