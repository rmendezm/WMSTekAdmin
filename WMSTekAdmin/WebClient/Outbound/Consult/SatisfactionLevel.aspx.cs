...
{
    public partial class SatisfactionLevel : BasePage
    {
        ...
        protected void btnExcelDetail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (index != -1)
                {
                    ...
                    theOutboundOrderConsult.Outbound.Id = outboundOrderConsultViewDTO.Entities[index].Id;
                    outboundOrderConsultAuxViewDTO = iDispatchingMGR.GetSatisfactionLevelByAnyParameter(theOutboundOrderConsult,context);
        ...
        {
            //Tipos de Tareas
            this.Master.ucMainFilter.trackOutboundTypeVisible = false;
            this.Master.ucMainFilter.listTrackOutboundType = new System.Collections.Generic.List<String>();
            this.Master.ucMainFilter.listTrackOutboundType = GetConst("SatisfactionLevelTrackOutboundType");
            ...
            this.Master.ucMainFilter.trackOutboundTypeNotIncludeAll = false;
        ...
        private void UpdateSession()
        {
            ...
            outboundOrderConsultViewDTO = iDispatchingMGR.FindSatisfactionLevel(context);
        ...
        protected void LoadOutboundOrderDetail(int index)
        {
            ...
            if (index != -1)
            {
                ...
                string Number = outboundOrderConsultViewDTO.Entities[index].Outbound.Number;

                outboundDetailViewDTO = iDispatchingMGR.FindSatisfactionLevelDetail(context, id);

                if (outboundDetailViewDTO.Entities.Count > 0)
                    this.lblNroDoc.Text = Number;
                ...
                {
                    this.lblNroDoc.Text = this.lblSinRegistro.Text;
                }
        ...
        {
            ScriptManager.RegisterStartupScript(Page, GetType(), "gridDetail", "initializeGridDragAndDrop('SatisfactionLevelDetail_FindAll', 'ctl00_MainContent_hsMasterDetail_ctl00_ctl01_grdDetail');", true);
        }
