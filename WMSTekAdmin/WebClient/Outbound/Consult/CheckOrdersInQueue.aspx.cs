...
{
    public partial class CheckOrdersInQueue : BasePage
    {
        ...
        protected void grdMgr_RowEditing(object sender, GridViewEditEventArgs e)
        {
            try
            {
                ...
                taskQueueViewDTO = (GenericViewDTO<TaskQueue>)Session[WMSTekSessions.CheckOrdersInQueue.OrdersList];
        ...
        {
            context.SessionInfo.IdPage = "CheckOrdersInQueue";
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            //this.Master.ucMainFilter.codeLabel = lblDocName.Text;
        ...
        private void UpdateSession()
        {
            ...
            {
                Session.Add(WMSTekSessions.CheckOrdersInQueue.OrdersList, taskQueueViewDTO);
                isValidViewDTO = true;
