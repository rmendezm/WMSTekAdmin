...
{
    public partial class DispatchLog : BasePage
    {
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.Master.ucMainFilter.DateBefore = CfgParameterName.DispatchLogDaysBefore;
            this.Master.ucMainFilter.DateAfter = CfgParameterName.DispatchLogDaysAfter;
        ...
        private void UpdateSession()
        {
            ...
            movementViewDTO = iDispatchingMGR.FindAllDispatchMovement(context);
        ...
        private void PopulateGrid()
        {
            ...
            if (!movementViewDTO.hasConfigurationError() && movementViewDTO.Configuration != null && movementViewDTO.Configuration.Count > 0)
                base.ConfigureGridVisible(grdMgr, movementViewDTO.Configuration);
        }
