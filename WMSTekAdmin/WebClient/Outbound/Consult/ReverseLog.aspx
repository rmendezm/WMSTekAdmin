<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReverseLog.aspx.cs" MasterPageFile="~/Shared/WMSTekContent.Master" Inherits="Binaria.WMSTek.WebClient.Outbound.Consult.ReverseLog" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("ReverseLog_FindAll", "ctl00_MainContent_grdMgr");
                        ...
                        <div id="divGrid" runat="server" visible="true" class="divGrid" onresize="SetDivs();">
                            ...
                            <asp:GridView ID="grdMgr" runat="server" AllowPaging="True" AllowSorting="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Tipo Salida" AccessibleHeaderText="InboundTypeName"
