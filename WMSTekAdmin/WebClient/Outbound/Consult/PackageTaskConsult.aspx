<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="PackageTaskConsult.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Consult.PackageTaskConsult" %>
                        ...
                        <div id="divGrid" runat="server" visible="true" class="divGrid" onresize="SetDivs();">
                            ...
                            <asp:GridView ID="grdMgr" runat="server" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Id Tipo Tarea" AccessibleHeaderText="TaskTypeCode" SortExpression="TaskType">
                                        <ItemTemplate>
                                            <center>
                                    ...
                                    <asp:TemplateField HeaderText="Cerrada" AccessibleHeaderText="CloseDate" SortExpression="CloseDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblCloseDate" runat="server" Text='<%# ((DateTime) Eval ("Task.CloseDate") > DateTime.MinValue)? Eval("Task.CloseDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Inicio Propuesto" AccessibleHeaderText="ProposalStartDate" SortExpression="ProposalStartDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblProposalStartDate" runat="server" Text='<%# ((DateTime) Eval ("Task.ProposalStartDate") > DateTime.MinValue)? Eval("Task.ProposalStartDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Fin Propuesto" AccessibleHeaderText="ProposalEndDate" SortExpression="ProposalEndDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblProposalEndDate" runat="server" Text='<%# ((DateTime) Eval ("Task.ProposalEndDate") > DateTime.MinValue)? Eval("Task.ProposalEndDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Inicio Real" AccessibleHeaderText="RealStartDate" SortExpression="RealStartDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRealStartDate" runat="server" Text='<%# ((DateTime) Eval ("Task.RealStartDate") > DateTime.MinValue)? Eval("Task.RealStartDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Fin Real" AccessibleHeaderText="RealEndDate" SortExpression="RealEndDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRealEndDate" runat="server" Text='<%# ((DateTime) Eval ("Task.RealEndDate") > DateTime.MinValue)? Eval("Task.RealEndDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Fecha Traza" AccessibleHeaderText="DateTrackTask" SortExpression="DateTrackTask">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDateTrackTask" runat="server" Text='<%# ((DateTime) Eval ("Task.DateTrackTask") > DateTime.MinValue)? Eval("Task.DateTrackTask", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Con CrossDocking" AccessibleHeaderText="AllowCrossDock" SortExpression="AllowCrossDock">
                                        <ItemTemplate>
                                            ...
                                            <center>
                                                <asp:CheckBox ID="chkAllowCrossDocking" runat="server" checked='<%# Eval ( "Task.AllowCrossDock" ) %>' Enabled="false"/>
                                            </center> 
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Iniciada" AccessibleHeaderText="StartDate" SortExpression="StartDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStartDate" runat="server" Text='<%# ((DateTime) Eval ("TaskDetail.StartDate") > DateTime.MinValue)? Eval("TaskDetail.StartDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Finalizada" AccessibleHeaderText="EndDate" SortExpression="EndDate">
                                        <ItemTemplate>
                                            <asp:Label ID="lblEndDate" runat="server" Text='<%# ((DateTime) Eval ("TaskDetail.EndDate") > DateTime.MinValue)? Eval("TaskDetail.EndDate", "{0:d}"):"" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Cant Propuesta" AccessibleHeaderText="ProposalQty" SortExpression="ProposalQty">
                                        <ItemTemplate>
                                            <asp:Label ID="lblProposalQty" runat="server" Text='<%# ((decimal)Eval ( "TaskDetail.ProposalQty" )==-1)?"":Eval ( "TaskDetail.ProposalQty" ) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Cant Real" AccessibleHeaderText="RealQty" SortExpression="RealQty">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRealQty" runat="server" Text='<%# ((decimal)Eval ( "TaskDetail.RealQty" )==-1)?"":Eval ( "TaskDetail.RealQty" ) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
