<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="DispatchAdvanceWaveConsult.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Consult.DispatchAdvanceWaveConsult" %>
...
<script type="text/javascript" language='Javascript'>
    ...
    function initializeGridDragAndDropCustom() {
        ...
        initializeGridDragAndDrop('DispatchAdvanced_FindAllWave', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
    }
</script> 
   ...
   <div id="divPrincipal" style="width:100%;height:100%;margin:0px;margin-bottom:80px">
                            ...
                            <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                <ContentTemplate>  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Nº Ola" AccessibleHeaderText="OutboundNumber" ItemStyle-CssClass="text">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sorting Uni" AccessibleHeaderText="QtySorting" SortExpression="QtySorting">
                                            <ItemTemplate>
                                                <asp:Label ID="lblQtySorting" runat="server" Text='<%#GetFormatedNumber( Eval("QtySorting")) %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="false"/>
                                        </asp:TemplateField>

                                        <asp:BoundField HeaderText="Sorting %" accessibleHeaderText="PctSorting" DataField="PctSorting" />
    ...
    <asp:Label id="lblFilterDate" runat="server" Text="Emisión" Visible="false" />    	
     <asp:Label id="lblFilterDoc" runat="server" Text="Nº Ola" Visible="false" />    	
