<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CheckOrdersInQueue.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Consult.CheckOrdersInQueue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("TaskQueue_GetOrdersInQueue", "ctl00_MainContent_grdMgr");
