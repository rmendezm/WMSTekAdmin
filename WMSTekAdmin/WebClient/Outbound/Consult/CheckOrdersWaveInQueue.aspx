<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CheckOrdersWaveInQueue.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Outbound.Consult.CheckOrdersWaveInQueue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("TaskQueue_GetOrdersWaveInQueue", "ctl00_MainContent_grdMgr");
                        ...
                        <asp:GridView ID="grdMgr" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:templatefield HeaderText="N° Ola" AccessibleHeaderText="OutboundOrderNumber" >
                                    <itemtemplate>
                                        <asp:label ID="lblOutboundOrder" runat="server" text='<%# Eval ( "IdDocumentBound" ) %>' />
                                    </itemtemplate>
                                </asp:templatefield>

                                <asp:templatefield HeaderText="PTL" AccessibleHeaderText="PtlTypeName" >
                                    <itemtemplate>
