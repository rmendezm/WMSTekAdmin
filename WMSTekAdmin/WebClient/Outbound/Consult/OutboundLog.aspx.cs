...
{
    public partial class OutboundLog : BasePage
    {
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.Master.ucMainFilter.listWmsProcessType = GetConst("OutboundLog");
            ...
            Master.ucMainFilter.tabLPNVisible = true;
            Master.ucMainFilter.divLpnVisible = false;
            Master.ucMainFilter.divLpnParentVisible = true;
            Master.ucMainFilter.divLpnSealNumberVisible = false;
            Master.ucMainFilter.divLpnIdLpnTypeVisible = false;
            Master.ucMainFilter.chkLpnIsParentVisible = false;
            Master.ucMainFilter.chkLpnIsNotParentVisible = false; 
            ...
            entityNameProperty = "OutboundLog_FindAll";
        }
        ...
        private void UpdateSession()
        {
            ...
            var filters = context.MainFilter.Where(f => f.FilterValues.Count > 0).ToList();

            //var lpnParentFilter = context.MainFilter.Where(f => f.Name == "LpnTarget").FirstOrDefault();

            //ClearFilter("LpnParentTarget");

            //if (lpnParentFilter != null && lpnParentFilter.FilterValues.Count > 0)
            //    CreateFilterByList("LpnParentTarget", new List<string>() { lpnParentFilter.FilterValues.First().Value });

            movementViewDTO = iWarehousingMGR.FindAllGenericOutLog(context, entityNameProperty);
