<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="RptReceipt.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.Receipt.RptReceipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function resizeDiv() {
            if ($("#ctl00_MainContent_divReport").length > 0) {
                ...
                document.getElementById("<%=rptViewReceipt.ClientID %>").style.height = h1;
                document.getElementById("<%=rptViewReceipt.ClientID %>").style.width = w2;
            }
        }
    ...
    <div id="divReport" runat="server" visible="false">
        <rsweb:ReportViewer ID="rptViewReceipt" runat="server" ProcessingMode="Remote" 
    ...
    <asp:Label ID="lblError2" Visible="False" runat="server" ForeColor="Red" 
        Text="El formato de recepción debe ser numérico" Font-Size="Small" />
    <div id="divWarning" runat="server" class="modalValidation" visible="false">
        <asp:Label ID="lblTitle1" runat="server" ForeColor="#4682B4" Text="Recepción" Font-Size="20pt" Font-Bold="True" />
        <br />    
