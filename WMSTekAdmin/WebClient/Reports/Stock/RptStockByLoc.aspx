<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master"
    CodeBehind="RptStockByLoc.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.Stock.RptStockByLoc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function resizeDiv() {
            if($("#ctl00_MainContent_divReport").length > 0 ) {
                ...
                document.getElementById("<%=rptViewStockByLocation.ClientID %>").style.height = h1;
                document.getElementById("<%=rptViewStockByLocation.ClientID %>").style.width = w2;
            }
        }
    ...
    <div id="divReport" runat="server" visible="false">
        <rsweb:ReportViewer ID="rptViewStockByLocation" runat="server" ProcessingMode="Remote"
