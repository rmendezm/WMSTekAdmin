...
{
    public partial class RptStockByLoc : BasePage
    {
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.ucMainFilterReport.FilterWarehouseAutoPostBack = false;
        ...
        private void LoadReport()
        {
            ...
            this.rptViewStockByLocation.ServerReport.ReportPath = MiscUtils.ReadSetting("ReportStockByLocPath", string.Empty);

            // Y el servidor donde está alojado el informe.
            this.rptViewStockByLocation.ServerReport.ReportServerUrl = new System.Uri(MiscUtils.ReadSetting("reportingServiceAddress", string.Empty));

            //Credenciales
            int total = rptViewStockByLocation.ServerReport.GetDataSources().Count;
            DataSourceCredentials[] permisos = new DataSourceCredentials[total];

            ReportDataSourceInfoCollection datasources = rptViewStockByLocation.ServerReport.GetDataSources();
            ...
            rptViewStockByLocation.ServerReport.SetDataSourceCredentials(permisos);
            ...
            rptViewStockByLocation.Attributes.Add("style", "margin-bottom: 50px;");

            rptViewStockByLocation.ShowPrintButton = false;

            // Añado el/los parámetro/s al ReportViewer.
            this.rptViewStockByLocation.ServerReport.SetParameters(reportParameter);

            rptViewStockByLocation.DataBind();

            divReport.Visible = true;

            rptViewStockByLocation.ServerReport.Refresh();
