<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="RptStockConsolidateItem.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.Stock.RptStockConsolidateItem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function resizeDiv() {
            if ($("#ctl00_MainContent_divReport").length > 0) {
                ...
                //alert(h1);
                document.getElementById("<%=rptViewStockConsolidateItem.ClientID %>").style.height = h1;
                document.getElementById("<%=rptViewStockConsolidateItem.ClientID %>").style.width = w2;
            }
        }
    ...
    <style>
        ...
        #ctl00_MainContent_rptViewStockConsolidateItem{
            height:500px;
            overflow: auto;
        }
    </style>
    ...
    <div id="divReport" runat="server" visible="false" >
        <rsweb:ReportViewer ID="rptViewStockConsolidateItem" runat="server" 
