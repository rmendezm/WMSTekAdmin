<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="RptHistoricItemsStored.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.RptHistoricItemsStored" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divWarning" runat="server" class="modalValidation" visible="false">
        <asp:Label ID="lblTitle1" runat="server" ForeColor="#4682B4" Text="Almacenados" Font-Size="20pt" Font-Bold="True" />
        <br />    
