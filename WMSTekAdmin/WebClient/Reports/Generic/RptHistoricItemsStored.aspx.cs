...
{
    public partial class RptHistoricItemsStored : BasePage
    {
        ...
        private void LoadReport()
        {
            ...
            if (int.Parse(year) < 2012 || int.Parse(year) > 2030)
            {
                ...
                else
                {
                    ...
                    this.rptViewReceiptHistoric.ServerReport.ReportPath = MiscUtils.ReadSetting("ReportHistoricItemsStoredPath", string.Empty);
