...
{
    public partial class RptHistoricItemsReception : BasePage
    {
        //GenericViewDTO<HistoricoItemRecepcionGridView> receiptViewDTO = new GenericViewDTO<HistoricoItemRecepcionGridView>();
        ...
        private void LoadReport()
        {
            ...
            if (int.Parse(year) < 2012 || int.Parse(year) > 2030)
            {
                ...
                else
                {
                    ...
                    this.rptViewReceiptHistoric.ServerReport.ReportPath = MiscUtils.ReadSetting("ReportHistoricItemsReceiptPath", string.Empty);
