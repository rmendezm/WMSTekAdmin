<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="RptHistoricItemsPickeados.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.RptHistoricItemsPickeados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divReport" runat="server" visible="false">
        <rsweb:ReportViewer ID="rptViewReceiptHistoric" runat="server" ProcessingMode="Remote" 
            AsyncRendering="true" SizeToReportContent="true" Height="100%" Width="100%" Style="margin-right: 11px" >
        </rsweb:ReportViewer>
    </div>
    ...
    <div id="divWarning" runat="server" class="modalValidation" visible="false">
        <asp:Label ID="lblTitle1" runat="server" ForeColor="#4682B4" Text="Pickeados" Font-Size="20pt" Font-Bold="True" />
        <br />    
