<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="RptHistoricItemsCyclicCount.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.RptHistoricItemsCyclicCount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divWarning" runat="server" class="modalValidation" visible="false">
        <asp:Label ID="lblTitle1" runat="server" ForeColor="#4682B4" Text="Conteo Cíclico" Font-Size="20pt" Font-Bold="True" />
        <br />    
