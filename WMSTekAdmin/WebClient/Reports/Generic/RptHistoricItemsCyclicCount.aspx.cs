...
{
    public partial class RptHistoricItemsCyclicCount : BasePage
    {
        ...
        private void LoadReport()
        {
            ...
            if (int.Parse(year) < 2012 || int.Parse(year) > 2030)
            {
                ...
                else
                {
                    ...
                    this.rptViewReceiptHistoric.ServerReport.ReportPath = MiscUtils.ReadSetting("ReportHistoricItemsCyclicCountPath", string.Empty);
