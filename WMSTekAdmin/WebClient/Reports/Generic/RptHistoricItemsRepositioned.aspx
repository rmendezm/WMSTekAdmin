<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="RptHistoricItemsRepositioned.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Reports.RptHistoricItemsRepositioned" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divWarning" runat="server" class="modalValidation" visible="false">
        <asp:Label ID="lblTitle1" runat="server" ForeColor="#4682B4" Text="Reposicionados" Font-Size="20pt" Font-Bold="True" />
        <br />    
