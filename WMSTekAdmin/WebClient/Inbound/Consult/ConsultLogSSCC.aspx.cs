...
{
    public partial class ConsultLogSSCC : BasePage
    {
        ...
        private string entityNameProperty = "ConsultLogSSCC_FindAll";
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.Master.ucMainFilter.listWmsProcessType = GetConst("ReceptionLog");
            ...
            this.Master.ucMainFilter.codeLabel = this.lblSSCC.Text;

            // Habilita el Filtro Avanzado
            this.Master.ucMainFilter.advancedFilterVisible = true;
            
            //Tab Reception
            this.Master.ucMainFilter.tabGS1Visible = true;
        ...
        private void UpdateSession()
        {
            ...
            movementViewDTO = iWarehousingMGR.FindAllSsccLog(context, entityNameProperty);
