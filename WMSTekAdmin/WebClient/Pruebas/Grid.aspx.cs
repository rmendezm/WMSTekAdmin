...
namespace Binaria.WMSTek.WebClient.Administration.Devices
{
    public partial class Grid : BasePage
    {
        ...
        // Propiedad para controlar el tipo de acción sobre la grilla
        ...
        // Propiedad para controlar el id seleccionado de la grilla
        private Int32 id
        {
            get
            {
        ...
        protected void btnEdit_Click(object sender, CommandEventArgs e) 
        {
            ...
            ShowModal(rowIndex, CRUD.Update);
        }
        ...
        protected void grdMgr_RowDeleting(object sender, GridRecordEventArgs e)
        {
           try
            {
...
//            this.Master.ucTaskBar.BtnNewClick += new EventHandler(btnNew_Click);
            ...
            this.Master.ucTaskBar.btnClientNewVisible = true;
        ...
        protected void PopulateGrid()
        {
         ...
         //   grdMgr.PageIndex = currentPage;
            ...
            if (!terminalViewDTO.hasConfigurationError() && terminalViewDTO.Configuration != null && terminalViewDTO.Configuration.Count > 0)
            {
                ...
                grdMgr.Columns[terminalViewDTO.Configuration[2].FieldName].Index = terminalViewDTO.Configuration[2].FieldOrder;
            }
         ...
         //   ucStatus.ShowRecordInfo(terminalViewDTO.Entities.Count, grdMgr.PageSize, grdMgr.PageCount, currentPage, grdMgr.AllowPaging);
            ...
            if (!terminalViewDTO.hasConfigurationError() && terminalViewDTO.Configuration != null && terminalViewDTO.Configuration.Count > 0)
            {
                grdMgr.Columns[terminalViewDTO.Configuration[2].FieldName].Visible = terminalViewDTO.Configuration[2].VisibleGrid;
             //   base.ConfigureGridVisible(grdMgr, terminalViewDTO.Configuration);
            }
        ...
        protected void ReloadData()
        {
            ...
            cs.RegisterClientScriptBlock(typeof(Grid), "RefreshGrid", "<script>return refreshGrid();</script>");
            */
            /*
