<%@ Page Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="BillingMoneyMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Billing.BillingMoneyMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("BillingMoney_FindAll", "ctl00_MainContent_grdMgr");
                        ...
                        <div id="divGrid" runat="server" class="divGrid" onresize="SetDivs();" >
                            <asp:GridView ID="grdMgr" DataKeyNames="Id" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Value" HeaderText="Valor" AccessibleHeaderText="Value" />
    ...
    <asp:UpdatePanel ID="upEditNew" runat="server" UpdateMode="Conditional">
        <ContentTemplate>             
            <%-- Pop up Editar/Nuevo BillingMoney --%>
            <div id="divEditNew" runat="server" visible="false">    
                ...
                <ajaxToolkit:ModalPopupExtender ID="modalPopUp" runat="server" TargetControlID="btnDummy"
                    PopupControlID="pnlBillingMoney" BackgroundCssClass="modalBackground" PopupDragHandleControlID="BillingMoneyCaption" Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="PnlBillingMoney" runat="server" CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="Caption" runat="server" CssClass="modalHeader">
                        <div class="divCaption">
                            <asp:Label ID="lblNew" runat="server" Text="Nueva Moneda" />
                            <asp:Label ID="lblEdit" runat="server" Text="Editar Moneda" />
                        ...
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divValue" runat="server" class="divControls">
                                ...
                                <div class="fieldLeft">
                                    ...
                                    <%--<asp:RegularExpressionValidator ID="revValue" runat="server" ControlToValidate="txtValue" ValidationGroup="EditNew" Text=" * " ErrorMessage ="Ingrese solo valores numericos" ValidationExpression="^[0-9]*" />--%>
                                    <asp:RangeValidator ID="rvValue" runat="server" ControlToValidate="txtValue" ValidationGroup="EditNew" Text=" * " ErrorMessage="Ingrese solo valores numericos" Type="Double" />
                                </div>
                            </div>
                        </div>    
    ...
    <asp:Label ID="lblConfirmDelete" runat="server" Text="¿Desea eliminar Moneda?" Visible="false" />
