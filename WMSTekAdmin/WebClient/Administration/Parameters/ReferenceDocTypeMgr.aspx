<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="ReferenceDocTypeMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Parameters.ReferenceDocTypeMgr" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("ReferenceDocType_FindAll", "ctl00_MainContent_grdMgr");
    ...
    <%-- FIN Modal Update Progress --%>
     ...
     <asp:UpdatePanel ID="upEditNew" runat="server" UpdateMode="Conditional">
        <ContentTemplate>             
            <%-- Pop up Editar/Nuevo Tipo de documento de referencia --%>
                ...
                <asp:Panel ID="pnlVendor" runat="server" CssClass="modalBox">
                    ...
                    <asp:Panel ID="VendorCaption" runat="server" CssClass="modalHeader">
                        <div class="divCaption">
                            <asp:Label ID="lblNew" runat="server" Text="Nuevo Tipo Doc. de Referencia" />
                            <asp:Label ID="lblEdit" runat="server" Text="Editar Tipo Doc. de Referencia" />
   ...
   <%-- Mensajes de Confirmacion y Auxiliares --%>
    <asp:Label ID="lblConfirmDelete" runat="server" Text="¿Desea eliminar este Tipo Doc. de Referencia?" Visible="false" />
