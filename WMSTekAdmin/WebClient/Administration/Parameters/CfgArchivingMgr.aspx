<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CfgArchivingMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Parameters.CfgArchivingMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("CfgArchiving_FindAll", "ctl00_MainContent_grdMgr");
                        ...
                        <div id="divGrid" runat="server" visible="true" class="divGrid" >  
                            <asp:GridView ID="grdMgr" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Código" AccessibleHeaderText="ArchivingCode">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblArchivingCode" runat="server" Text='<%# Eval ( "ArchivingCode" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Nombre" AccessibleHeaderText="ArchivingName">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblArchivingName" runat="server" Text='<%# Eval ( "ArchivingName" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                       
                                        
                                        <asp:TemplateField HeaderText="Hora Inicio" AccessibleHeaderText="StartTime">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblStartTime" runat="server" Text='<%# (((DateTime)Eval ( "StartDate" )).ToShortDateString() == "01/01/0001" ? "" : ((DateTime)Eval ( "StartTime" )).ToLongTimeString()) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Hora Fin" AccessibleHeaderText="EndTime">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblEndTime" runat="server" Text='<%# (((DateTime)Eval ( "EndDate" )).ToShortDateString() == "01/01/0001" ? "" : ((DateTime)Eval ( "EndTime" )).ToLongTimeString()) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Habilitado" AccessibleHeaderText="Status">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
         ...
         <ContentTemplate>
             <div id="divEditNew" runat="server" visible="false">
                 ...
                 <ajaxToolkit:ModalPopupExtender 
                     ...
                     PopupControlID="pnlArchiving" 
                     BackgroundCssClass="modalBackground" 
                     PopupDragHandleControlID="ArchivingCaption"
                     Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="pnlArchiving" runat="server" CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="ArchivingCaption" runat="server" CssClass="modalHeader">
                    ...
                    <div class="modalControls">
                        ...
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divStartHour" runat="server" class="divControls">
                                <div class="fieldRight">
                                    <asp:Label ID="lblStartHour" runat="server" Text="Hora Inicio 24H" />
                                </div>
                                <div class="fieldLeft">
                            ...
                            <div id="divEndHour" runat="server" class="divControls">
                                <div class="fieldRight">
                                    <asp:Label ID="lblEndHour" runat="server" Text="Hora Fin 24H" />
                                </div>
                                <div class="fieldLeft">
