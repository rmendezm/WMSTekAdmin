<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CfgBillingMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Parameters.CfgBillingMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("CfgBilling_FindAll", "ctl00_MainContent_grdMgr");
                        ...
                        <div id="divGrid" runat="server" visible="true" class="divGrid" >  
                            <asp:GridView ID="grdMgr" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Código" AccessibleHeaderText="BillingCode">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblUtilityCode" runat="server" Text='<%# Eval ( "BillingCode" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Nombre" AccessibleHeaderText="BillingName">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblUtilityName" runat="server" Text='<%# Eval ( "BillingName" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
         ...
         <ContentTemplate>
             <div id="divEditNew" runat="server" visible="false">
                 ...
                 <ajaxToolkit:ModalPopupExtender 
                     ...
                     PopupControlID="pnlBilling" 
                     BackgroundCssClass="modalBackground" 
                     PopupDragHandleControlID="BillingCaption"
                     Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="pnlBilling" runat="server" CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="BillingCaption" runat="server" CssClass="modalHeader">
