<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="UtilityMgr.aspx.cs" 
    Inherits="Binaria.WMSTek.WebClient.Administration.Parameters.UtilityMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("CfgUtility_FindAll", "ctl00_MainContent_grdMgr");
                        ...
                        <div id="divGrid" runat="server" visible="true" class="divGrid" >  
                            <asp:GridView ID="grdMgr" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Código" AccessibleHeaderText="UtilityCode">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblUtilityCode" runat="server" Text='<%# Eval ( "UtilityCode" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Nombre" AccessibleHeaderText="UtilityName">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblUtilityName" runat="server" Text='<%# Eval ( "UtilityName" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
         ...
         <ContentTemplate>
             <div id="divEditNew" runat="server" visible="false">
                 ...
                 <ajaxToolkit:ModalPopupExtender 
                     ...
                     PopupControlID="pnlUtility" 
                     BackgroundCssClass="modalBackground" 
                     PopupDragHandleControlID="UtilityCaption"
                     Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="pnlUtility" runat="server" CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="UtilityCaption" runat="server" CssClass="modalHeader">
                    ...
                    <div class="modalControls">
                        ...
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divName" runat="server" class="divControls">
                                <div class="fieldRight">
                                    <asp:Label ID="lblUtilityNameEdit" runat="server" Text="Nombre" /></div>
                                <div class="fieldLeft">
