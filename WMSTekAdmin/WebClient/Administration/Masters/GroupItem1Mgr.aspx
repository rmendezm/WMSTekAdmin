<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="GroupItem1Mgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Masters.GroupItem1Mgr" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("GrpItem1_FindAll_Filters", "ctl00_MainContent_grdMgr");
                                    ...
                                    <asp:TemplateField HeaderText="Dueño" AccessibleHeaderText="OwnName">
                                        <ItemTemplate>
                                            <div style="word-wrap: break-word;">
                                                <asp:Label ID="lblOwnName" runat="server" Text='<%# Eval  ( "Owner.Name" ) %>' ></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
    ...
    <%-- Pop up Editar/Nuevo GroupItem1 --%>
        ...
        <ContentTemplate>             
            ...
            <div id="divEditNew" runat="server" visible="false">        
                ...
                <ajaxToolkit:ModalPopupExtender ID="modalPopUp"  runat="server" TargetControlID="btnDummy"
                    PopupControlID="pnlGroupItem1" BackgroundCssClass="modalBackground" PopupDragHandleControlID="GroupItem1Caption"
                    Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="pnlGroupItem1" runat="server"  CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="GroupItem1Caption" runat="server" CssClass="modalHeader">
                         <div class="divCaption">
                            <asp:Label ID="lblNew" runat="server" Text="Nuevo Sector" />
                            <asp:Label ID="lblEdit" runat="server" Text="Editar Sector" />
   ...
   <%-- Mensajes de Confirmacion y Auxiliares --%>
    <asp:Label ID="lblConfirmDelete" runat="server" Text="¿Desea eliminar este Sector?" Visible="false" />
