<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CityMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Masters.CityMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("City_FindAll", "ctl00_MainContent_grdMgr");
                            ...
                            <asp:GridView ID="grdMgr" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Estado" AccessibleHeaderText="State">
                                            <ItemTemplate>
                                                <div style="word-wrap: break-word;">
                                                    <asp:Label ID="lblStateName" runat="server" Text='<%# Eval ( "State.Name" ) %>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                        </asp:TemplateField>
        ...
        <ContentTemplate>
            ...
            <div id="divEditNew" runat="server" visible="false">
                ...
                <ajaxToolkit:ModalPopupExtender ID="modalPopUp" runat="server" TargetControlID="btnDummy"
                    PopupControlID="pnlCity" BackgroundCssClass="modalBackground" PopupDragHandleControlID="CityCaption"
                    Drag="true">
                </ajaxToolkit:ModalPopupExtender>
                <asp:Panel ID="pnlCity" runat="server" CssClass="modalBox">
                    <%-- Encabezado --%>
                    <asp:Panel ID="CityCaption" runat="server" CssClass="modalHeader">
                            ...
                            <div id="divState" runat="server" class="divControls">
                                ...
                                <div class="fieldLeft">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvState" runat="server" ControlToValidate="ddlState"
                                        InitialValue="-1" ValidationGroup="EditNew" Text=" * " ErrorMessage="Región es requerido" />          
                                </div>
                            </div>
            ...
            <div id="divLoad" runat="server" visible="false">
                ...
                <asp:Panel ID="panelLoad" runat="server" CssClass="modalBox" >
                    ...
                    <asp:Panel ID="panelCaptionLoad" runat="server" CssClass="modalHeader">
                        <div class="divCaption">
                            <asp:Label ID="Label3" runat="server" Text="Carga Masiva de Ciudades" />
                            <asp:HyperLink runat="server" NavigateUrl="~/WebResources/XlsTemplateFile/Carga%20Masiva%20Ciudad.xlsx" 
    ...
    <asp:Label ID="lblConfirmDelete" runat="server" Text="¿Desea eliminar esta ciudad?" Visible="false" />
    <asp:Label ID="lblTitle" runat="server" Text="Mantenedor de Ciudades" Visible="false" />
    ...
    <asp:Label ID="lblNotStatesInFile" runat="server" Text="No existen ciudades en el archivo." Visible="false" />
