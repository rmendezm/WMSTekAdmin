<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="CountryMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Masters.CountryMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
                                    ...
                                    <asp:TemplateField HeaderText="Nombre" AccessibleHeaderText="Name">
                                        <ItemTemplate>
                                            <div style="word-wrap: break-word;">
                                                <asp:Label ID="lblCountryName" runat="server" Text='<%# Eval ( "Name" ) %>'></asp:Label>
                                            </div>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                ...
                <asp:Panel ID="pnlCountry" runat="server" CssClass="modalBox">
                    ...
                    <asp:Panel ID="CountryCaption" runat="server" CssClass="modalHeader">
                        <div class="divCaption">
                            <asp:Label ID="lblNew" runat="server" Text="Nuevo País" />
                            <asp:Label ID="lblEdit" runat="server" Text="Editar País" />
                        ...
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divName" runat="server" class="divControls">
                                <div class="fieldRight">
                                    <asp:Label ID="lblCountryName" runat="server" Text="Nombre" /></div>
                                <div class="fieldLeft">
                ...
                <asp:Panel ID="panelLoad" runat="server" CssClass="modalBox" >
                    ...
                    <asp:Panel ID="panelCaptionLoad" runat="server" CssClass="modalHeader">
                        <div class="divCaption">
                            ...
                            <asp:HyperLink runat="server" NavigateUrl="~/WebResources/XlsTemplateFile/Carga%20Masiva%20Pais.xlsx" 
    ...
    <asp:Label ID="lblConfirmDelete" runat="server" Text="¿Desea eliminar este país?" Visible="false" />
    <asp:Label ID="lblTitle" runat="server" Text="Mantenedor de Paises" Visible="false" />
    ...
    <asp:Label ID="lblNotCountriesInFile" runat="server" Text="No existen paises en el archivo." Visible="false" />
