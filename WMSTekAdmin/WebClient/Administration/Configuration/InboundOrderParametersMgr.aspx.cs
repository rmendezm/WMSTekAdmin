...
{
    public partial class InboundOrderParametersMgr : BasePage
    {
            ...
            try
            {
                ...
                if (base.webMode == WebMode.Normal)
                {
                    ...
                    if (!Page.IsPostBack)
                    {
                        ...
                        if (trvInboundType.Nodes[0] != null)
                        {
                            trvInboundType.Nodes[0].Text = "<b>" + objUser.Company.Name + "</b>";
                            trvInboundType.Nodes[0].ToolTip = objUser.Company.Name;
                        }
                    ...
                    if (ValidateSession(WMSTekSessions.InboundOrderParametersMgr.CfgParameterList))
                    {
                        cfgParameterViewDTO = (GenericViewDTO<CfgParameter>)Session[WMSTekSessions.InboundOrderParametersMgr.CfgParameterList];
                        isValidViewDTO = true;
                    }
        ...
        protected void trvInboundType_SelectedNodeChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ValidateSession(WMSTekSessions.Global.LoggedInUser))
                {
                    ...
                    if (!string.IsNullOrEmpty(TreeId))
                    {
                        ...
                        if (tv.SelectedNode.Depth == 0)
                        {
                            ...
                            TreeNode company = trvInboundType.FindNode(TreeId);
        ...
        private void UpdateSession(bool showError)
        {
            ...
            cfgParameterViewDTO = iConfigurationMGR.FindAllParametersDocCompany(context);

            if (!cfgParameterViewDTO.hasError() && cfgParameterViewDTO.Entities != null)
            {
                Session.Add(WMSTekSessions.InboundOrderParametersMgr.CfgParameterList, cfgParameterViewDTO);
                isValidViewDTO = true;
        ...
        {
            cfgParameterViewDTO = iConfigurationMGR.GetParametersDocOwner(context, idOwn);
        ...
        private void GetParametersOwnerWarehouseById(bool showError, int idOwn, int idWhs)
        {
            ...
            cfgParameterViewDTO = iConfigurationMGR.GetParamDocWarehouses(context, idOwn, idWhs);
        ...
        protected void ReloadData()
        {
            ...
            if (isValidViewDTO)
            {
                ...
                if (trvInboundType.Nodes[0] != null)
                {
                    trvInboundType.Nodes[0].Selected = true;
                    trvInboundType.Nodes[0].Collapse();
                }
            }
        }
