...
CodeBehind="RulesItemsMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Configuration.RulesItemsMgr" %>
                                                        ...
                                                        <asp:GridView ID="grdMgr" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ShowHeader="False" AccessibleHeaderText="Actions">
                                                                    <HeaderTemplate>
                                                                        <input type="checkbox" onclick="toggleCheckBoxes('<%= grdMgr.ClientID %>', 'chkSelectItem', this.checked)" id="chkAll" title="Seleccionar todos" />
                                                                        <%--<input type="checkbox" onclick="toggleCheckCustom('<%= grdMgr.ClientID %>', 'chkSelectItem', this.checked)" id="chkAll" title="Seleccionar todos" />--%>
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <center>
                                                                            <div style="width: 20px">
                                                                                <asp:CheckBox ID="chkSelectItem" runat="server"   Checked='<%# ((int) Eval("AsigRuleItem") == 1)? true : false %>'  />
                                                                            </div>
                                                                        </center>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
...
<asp:Label id="lblNoRuleSelected" runat="server" Text="Debe seleccionar al menos una regla." Visible="false" /> 
