<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="LpnParametersMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Configuration.LpnParametersMgr" %>
...
<script type="text/javascript" language='Javascript'>  
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("CfgParameterWarehouseLPN_FindAll", "ctl00_MainContent_hsMasterDetail_ctl00_ctl01_grdMgr");
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            AllowPaging="False"
                                            EnableViewState="False" AutoGenerateColumns="False" OnRowDataBound="grdMgr_RowDataBound"
