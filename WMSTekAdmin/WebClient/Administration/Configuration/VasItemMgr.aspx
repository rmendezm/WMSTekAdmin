<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="VasItemMgr.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Configuration.VasItemMgr" %>
                                                        ...
                                                        <asp:GridView ID="grdMgr" 
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ShowHeader="False" AccessibleHeaderText="Actions">
                                                                    <HeaderTemplate>
                                                                        <input type="checkbox" onclick="toggleCheckBoxes('<%= grdMgr.ClientID %>', 'chkSelectVas', this.checked)" id="chkAll" title="Seleccionar todos" />
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <center>
                                                                            <div style="width: 20px">
                                                                                <asp:CheckBox ID="chkSelectVas" runat="server"  Checked='<%# ((bool) Eval("IsAssignedVasItem")) %>' />
                                                                            </div>
                                                                        </center>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Vas" AccessibleHeaderText="Name">
                                                                    <ItemTemplate>
                                                                        <div >
