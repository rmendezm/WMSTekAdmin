<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocationParametersMgr.aspx.cs"
    MasterPageFile="~/Shared/WMSTekContent.Master" Inherits="Binaria.WMSTek.WebClient.Administration.Configuration.LocationParametersMgr" %>
...
function resizeDivPrincipal() {
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("CfgParamLocationCompany_FindAll", "ctl00_MainContent_hsMasterDetail_ctl00_ctl01_grdMgr");
    ...
    <div id="divMainPrincipal" runat="server" style="width: 100%; height: 100%; margin: 0px; margin-bottom: 80px">
        <spl:Splitter LiveResize="false" CookieDays="0" ID="hsMasterDetail" runat="server"
            StyleFolder="~/WebResources/Styles/Obout/default">
