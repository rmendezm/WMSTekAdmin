<%@ Page Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" CodeBehind="LabelBulkB2BConsult.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Administration.Devices.LabelBulkB2BConsult" %>
...
<script type="text/javascript" language="javascript">
                ...
                <div ID="divPrintLabel" runat="server" class="divPrintLabel" visible="false">
                    ...
                    <div class="divCtrsFloatLeft">
                        ...
                        <div id="div1" runat="server" class="divControls">
                            ...
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlPrinters" runat="server" AutoPostBack="false"  />
                            ...
                            <div id="divGrid" runat="server" class="divGrid" onresize="resizeDivPrincipal();" >                
                                <asp:GridView ID="grdMgr" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <asp:TemplateField HeaderText="Centro Dist." AccessibleHeaderText="Warehouse">
                                        ...
                                        <asp:TemplateField HeaderText="Etiqueta Lpn" AccessibleHeaderText="LabelCodeLPNB2B" Visible="true">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLabelCodeLPN" runat="server" Text='<%# Eval("Customer.CustomerB2B.LabelCodeLPN") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
    ...
    <asp:Label ID="lblFilterCustomerName" runat="server" Text="Cliente" Visible="false" />
