...
{
    public partial class LabelItemConsult: BasePage
    {
        #region "Declaración de Variables"

        private GenericViewDTO<ItemUom> labelItemViewDTO = new GenericViewDTO<ItemUom>();
        ...
        protected override void Page_Init(object sender, EventArgs e)
        {
            try
            {
                ...
                if (base.webMode == WebMode.Normal)
                {
                    ...
                    {
                        if (ValidateSession(WMSTekSessions.Label.Item))
                        {
                            labelItemViewDTO = (GenericViewDTO<ItemUom>)Session[WMSTekSessions.Label.Item];
                            isValidViewDTO = true;
                        }
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            //labelTemplateViewDTO = iLabelMGR.GetLabelByCode("ITEM", context);
            ...
            if (Convert.ToInt32(ddlLabelSize.SelectedValue) > 0)
            {
                foreach (GridViewRow row in this.grdMgr.Rows)
                {
                    ...
                    if (chkbox.Checked)
                    {
                        ...
                        String lblIdUom = labelItemViewDTO.Entities[index].Id.ToString();
                        //Label lblIdItem = (Label)row.FindControl("lblIdItem");
                        //Label lblIdUom = (Label)row.FindControl("lblIdUom");
                        ...
                        int IdUom = 0;
                        if (lblIdUom != string.Empty)
                            IdUom = Convert.ToInt32(lblIdUom);

                        string xmlParam = iLabelMGR.GetForItem(IdItem, IdUom);
        ...
        {
            context.SessionInfo.IdPage = "LabelItemConsult";
        ...
        private void UpdateSession(bool showError)
        {
            ...
            labelItemViewDTO = iWarehousingMGR.FindAllItemUom(context);

            if (!labelItemViewDTO.hasError() && labelItemViewDTO.Entities != null)
            {
                Session.Add(WMSTekSessions.Label.Item, labelItemViewDTO);
                isValidViewDTO = true;
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            this.Master.ucMainFilter.uomTypeVisible = true;
        ...
        {
            ScriptManager.RegisterStartupScript(Page, GetType(), "gridHeader", "initializeGridDragAndDrop('ItemUom_FindAll', 'ctl00_MainContent_grdMgr');", true);
        }
