...
var dhtmlwindow={
imagefiles:['windowfiles/min.gif', 'WebResources/Images/ModalPopup/close.gif', 'windowfiles/restore.gif', 'windowfiles/resize.gif'], //Path to 4 images used by script, in that order
