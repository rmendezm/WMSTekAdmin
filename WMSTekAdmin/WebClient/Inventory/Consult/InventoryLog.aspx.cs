...
{
    public partial class InventoryLog : BasePage
    {
        ...
        protected void Initialize()
        {
            ...
            {
                if (ValidateSession(WMSTekSessions.InventoryConsult.InventoryLogList))
                {
                    movementViewDTO = (GenericViewDTO<MovementWeb>)Session[WMSTekSessions.InventoryConsult.InventoryLogList];
                    isValidViewDTO = true;
                }
            }
        }
        ...
        private void InitializeFilter(bool init, bool refresh)
        {
            ...
            if(this.Master.ucMainFilter.listWmsProcessType == null)
                this.Master.ucMainFilter.listWmsProcessType = new System.Collections.Generic.List<string>();
            this.Master.ucMainFilter.listWmsProcessType = GetConst("InventoryLog");
            ...
            entityNameProperty = "InventoryLog_FindAll";
        }
        ...
        private void UpdateSession()
        {
            ...
            {
                Session.Add(WMSTekSessions.InventoryConsult.InventoryLogList, movementViewDTO);
                isValidViewDTO = true;
