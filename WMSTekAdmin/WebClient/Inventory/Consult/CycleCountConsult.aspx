<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CycleCountConsult.aspx.cs" MasterPageFile="~/Shared/WMSTekContent.Master" Inherits="Binaria.WMSTek.WebClient.Inventory.CycleCountWebConsult" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("CycleCountConsult", "ctl00_MainContent_grdMgr");
                                ...
                                EnableTheming="false">
                                 ...
                                 <Columns>
                                   ...
                                   <asp:templatefield headertext="Op. Requeridos" accessibleHeaderText="WorkersRequired" SortExpression="WorkersRequired">
                                    ...
                                    <asp:TemplateField HeaderText="Cant. Sistema" AccessibleHeaderText="ProposalQty">
                                        <ItemTemplate>
                                            <div style="word-wrap: break-word;">
                                    ...
                                    <asp:templatefield headertext="Cant. Contada" accessibleHeaderText="RealQty" SortExpression="RealQty">
                                        <itemtemplate>
                                            <div style="word-wrap: break-word;">
