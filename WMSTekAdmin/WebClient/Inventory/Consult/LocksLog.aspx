<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="LocksLog.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Inventory.Consult.LocksLog" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("BlocksLog_FindAll", "ctl00_MainContent_grdMgr");
                            ...
                            <asp:GridView ID="grdMgr" runat="server" AllowPaging="True" AllowSorting="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Item" AccessibleHeaderText="ItemDescription" SortExpression="ItemDescription">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLongItemName" runat="server" Text='<%# Eval ("Item.Description") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Id UOM" AccessibleHeaderText="IdUOM" SortExpression="IdUOM">
                                        <ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="ReasonName" HeaderText="Nombre Razón" AccessibleHeaderText="ReasonName"
