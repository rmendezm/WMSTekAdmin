<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MovementLog.aspx.cs" MasterPageFile="~/Shared/WMSTekContent.Master" Inherits="Binaria.WMSTek.WebClient.Movement.Consult.MovementLog" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("MovementLog_FindAll", "ctl00_MainContent_grdMgr");
                            ...
                            <asp:GridView ID="grdMgr" runat="server" AllowPaging="True" AllowSorting="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Qty Movimiento" AccessibleHeaderText="ItemQtyMov" SortExpression="ItemQtyMov">
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="lblItemQtyMov" runat="server" Text='<%# GetFormatedNumber((decimal)Eval("ItemQtyMov")) %>' />
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
