<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/WMSTekContent.Master" CodeBehind="KitVasLog.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Movement.Consult.KitVasLog" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("KitVasLog_FindAll", "ctl00_MainContent_grdMgr");
                    ...
                    <ContentTemplate>
                        <div id="divGrid" runat="server" visible="true" class="divGrid" onresize="SetDivs();">
                            ...
                            <asp:GridView ID="grdMgr" runat="server" AllowPaging="True" AllowSorting="False"
                                ...
                                EnableTheming="false">
                                <Columns>
                                    <asp:TemplateField HeaderText="ID Movto" AccessibleHeaderText="MovementId" SortExpression="MovementId">
                                        <ItemTemplate>
                                            <center>
                                    ...
                                    <asp:TemplateField HeaderText="Tipo Salida" AccessibleHeaderText="OutboundType"
                                        ItemStyle-CssClass="text">
                                        <ItemTemplate>
                                            <asp:Label ID="lblOutboundTypeName" runat="server" Text='<%# Eval ( "OutboundType.Name" ) %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Qty Item" AccessibleHeaderText="ItemQtyMov" SortExpression="ItemQtyMov">
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="lblItemQtyMov" runat="server" Text='<%# ((decimal) Eval ("ItemQtyMov") == -1)?" ":Eval ("ItemQtyMov") %>' />
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Qty en Origen" AccessibleHeaderText="QtyBeforeSource"
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="lblQtyBeforeSource" runat="server" Text='<%# ((decimal) Eval ("QtyBeforeSource") == -1)?" ":Eval ("QtyBeforeSource") %>' />
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Qty en Destino" AccessibleHeaderText="QtyBeforeTarget"
                                        ...
                                        <ItemTemplate>
                                            <center>
                                                <asp:Label ID="lblQtyBeforeTarget" runat="server" Text='<%# ((decimal) Eval ("QtyBeforeTarget") == -1)?" ":Eval ("QtyBeforeTarget") %>' />
                                            </center>
                                        </ItemTemplate>
                                    </asp:TemplateField>
