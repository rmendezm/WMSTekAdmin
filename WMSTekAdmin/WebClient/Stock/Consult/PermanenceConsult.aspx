<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermanenceConsult.aspx.cs" MasterPageFile="~/Shared/WMSTekContent.Master"  Inherits="Binaria.WMSTek.WebClient.Stocks.PermanenceConsult" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(document).ready(function () {
        initializeGridDragAndDrop("PermanenceConsult", "ctl00_MainContent_grdMgr");
                          ...
                          <asp:GridView ID="grdMgr" 
                            ...
                            EnableTheming="false">
                             ...
                             <Columns>
                                ...
                                <asp:templatefield headertext="Nombre" accessibleHeaderText="LongItemName" SortExpression="LongItemName">
                                    <itemtemplate>
                                        <div style="word-wrap: break-word;">
                               ...
                               <asp:templatefield headertext="Cantidad" accessibleHeaderText="ItemQty" SortExpression="ItemQty">
                                ...
                                <asp:templatefield headertext="Días Permanencia" accessibleHeaderText="Permanence" SortExpression="Permanence">
                                    <ItemStyle Wrap="false" />
                                    <itemtemplate>
                                        <center>
                                            <div style="word-wrap: break-word;">                                
                                                <asp:Label ID="lblPermanence" runat="server"></asp:Label>
                                            </div>
                                        </center>    
                                    </itemtemplate>
                                </asp:templatefield>
