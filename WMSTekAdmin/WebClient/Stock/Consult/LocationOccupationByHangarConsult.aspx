<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocationOccupationByHangarConsult.aspx.cs" MasterPageFile="~/Shared/WMSTekContent.Master" Inherits="Binaria.WMSTek.WebClient.Stocks.LocationOccupationByHangarConsult" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            initializeGridDragAndDrop("GetLocationOccupationByHangar", "ctl00_MainContent_grdMgr");
                             ...
                             <asp:GridView ID="grdMgr" 
                                ...
                                EnableTheming="false">
                                 ...
                                 <Columns>
                                    ...
                                    <asp:templatefield HeaderText="Cod. Hangar" AccessibleHeaderText="HngCode" ItemStyle-CssClass="text">
                                        <itemtemplate>
                                           <asp:label ID="lblHngCode" runat="server" text='<%# Eval ( "Hangar.Code" ) %>' />
                                        </itemtemplate>
                                     </asp:templatefield>
                         
                                    <asp:templatefield HeaderText="Bodega" AccessibleHeaderText="HngName">
                                        <itemtemplate>
                                           <asp:label ID="lblHngName" runat="server" text='<%# Eval ( "Hangar.Name" ) %>' />
                                        </itemtemplate>
                                     </asp:templatefield>                         
