...
{
    public partial class StockLocationWebConsult : BasePage
    {
        ...
        protected void Initialize()
        {
            ...
            else
            {
                ...
                {
                    stockViewDTO = (GenericViewDTO<Framework.Entities.Warehousing.Stock>)Session[WMSTekSessions.StockConsult.StockLocationList];
                    isValidViewDTO = true;
                }
            }
        }
        ...
        private void UpdateSession()
        {
            ...
            stockViewDTO = iWarehousingMGR.FindAllStockLocation(context);

            if (!stockViewDTO.hasError() && stockViewDTO.Entities != null)
            {
                Session.Add(WMSTekSessions.StockConsult.StockLocationList, stockViewDTO);
                isValidViewDTO = true;
        ...
        {
            ScriptManager.RegisterStartupScript(Page, GetType(), "gridHeader", "initializeGridDragAndDrop('Stock_FindAllLocation', 'ctl00_MainContent_grdMgr');", true);
        }
