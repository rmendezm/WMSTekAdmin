<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="GenerateAsnFileLaPolar.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Clientes.GenerateAsnFileLaPolar" %>
...
<script type="text/javascript" language="javascript">
    ...
    function initializeGridDragAndDropCustom() {
        ...
        initializeGridDragAndDrop('GenerateAsnFileLaPolar', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
    }
...
<div id="divPrincipal" style="width:100%;height:100%;margin:0px;margin-bottom:80px">
                            ...
                            <asp:UpdatePanel ID="upGrid" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
                                <ContentTemplate>  
                                    ...
                                    <Columns>
                                        ...
                                        <asp:templatefield HeaderText="Tipo Despacho" AccessibleHeaderText="DispatchType" ItemStyle-CssClass="text">
                                            <itemtemplate>
    ...
    <asp:Label id="lblDoesntExistItemCustomerMatch" runat="server" Text="No existe registro en Item Customer en Item con código " Visible="false" />  
