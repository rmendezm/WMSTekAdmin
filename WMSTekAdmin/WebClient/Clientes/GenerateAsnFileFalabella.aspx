<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="GenerateAsnFileFalabella.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Clientes.GenerateAsnFileFalabella" %>
...
<script type="text/javascript" language="javascript">
    ...
    function initializeGridDragAndDropCustom() {
        ...
        initializeGridDragAndDrop('GetDispatchSpecialHeader', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
...
<div id="divPrincipal" style="width:100%;height:100%;margin:0px;margin-bottom:80px">
                                            ...
                                            <asp:GridView ID="grdDetail" runat="server" SkinID="grdDetail"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="F. Fifo" AccessibleHeaderText="Fifo" ItemStyle-CssClass="text">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFifo" runat="server" text='<%# Eval ( "Fifo", "{0:d}" ) %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    
                                                    <asp:TemplateField HeaderText="F. Expiración" AccessibleHeaderText="Expiration" ItemStyle-CssClass="text">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblExpiration" runat="server" text='<%# Eval ( "Expiration", "{0:d}" ) %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                    
                                                    <asp:TemplateField HeaderText="F. Fabricación" AccessibleHeaderText="Fabrication" ItemStyle-CssClass="text">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblFabrication" runat="server" text='<%# Eval ( "Fabrication", "{0:d}" ) %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
    ...
    <div id="divMensaje" class="modalBox" style="z-index: 400001; display: none; position: absolute; 
        min-width: 400px; max-width:600px;  top: 200px; margin-top: 0;"  runat="server">
