<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true"
    CodeBehind="GenerateAsnFileSodimac.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Clientes.GenerateAsnFileSodimac" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function initializeGridDragAndDropCustom() {
            ...
            initializeGridDragAndDrop('GetDispatchSpecialHeaderASNSodimac', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
        }
                                        ...
                                        <div class="col-md-12"> 
                                            <div id="divGrid" runat="server" class="textLeft">
                                                <asp:GridView ID="grdDetail" runat="server" SkinID="grdDetail" DataKeyNames="Id"
                                                    EnableViewState="False" AutoGenerateColumns="False" OnRowCreated="grdDetail_RowCreated"
                        ...
                        <div class="divCtrsFloatLeft">
                            ...
                            <div id="divName" runat="server" class="divControls">
                                ...
                                <div class="fieldLeft">
                                    ...
                                    <%--<ajaxToolkit:MaskedEditExtender ID="meeHourAsn" runat="server" Mask="99:99" AutoComplete="false"
                                        MaskType="Time" ClearMaskOnLostFocus="true" UserTimeFormat="TwentyFourHour" TargetControlID="txtHourAsn" />--%>
                                </div>
                            </div>
