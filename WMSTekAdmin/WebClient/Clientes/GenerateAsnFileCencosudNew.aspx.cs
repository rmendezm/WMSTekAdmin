...
{
    public partial class GenerateAsnFileCencosudNew : BasePage
    {
                        ...
                        if (dispatchDetailViewDTO.Entities != null && dispatchDetailViewDTO.Entities.Count > 0)
                        {
                            ...
                            else
                            {
                                ...
                                foreach (DispatchDetail disp in dispatchDetailViewDTO.Entities)
                                {
                                    ...
                                    rowDet["NOMB_SUCURSAL_DESTINO"] = string.IsNullOrEmpty(disp.OutboundDetail.OutboundOrder.Branch.Code) ? "" : disp.OutboundDetail.OutboundOrder.Branch.Code;
