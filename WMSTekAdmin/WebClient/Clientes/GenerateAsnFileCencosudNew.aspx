<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="GenerateAsnFileCencosudNew.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Clientes.GenerateAsnFileCencosudNew" %>
...
<script type="text/javascript" language="javascript">
   function resizeDiv() {
    ...
    function initializeGridDragAndDropCustom() {
        ...
        initializeGridDragAndDrop('GetDispatchSpecialHeaderParis', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
    }
