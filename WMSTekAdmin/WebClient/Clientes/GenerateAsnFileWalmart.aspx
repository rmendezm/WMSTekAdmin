<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/WMSTekContent.Master" AutoEventWireup="true" 
    CodeBehind="GenerateAsnFileWalmart.aspx.cs" Inherits="Binaria.WMSTek.WebClient.Clientes.GenerateAsnFileWalmart" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language='Javascript'>
        ...
        function initializeGridDragAndDropCustom() {
            ...
            initializeGridDragAndDrop('GetDispatchSpecialHeaderEasy', 'ctl00_MainContent_hsMasterDetail_topPanel_ctl01_grdMgr');
        }
